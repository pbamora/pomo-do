...
export default function Modal() {
  ...
  return (
    <>
      <div className="absolute z-40 w-screen h-screen bg-greenL bg-opacity-20">
        <div className="flex justify-center items-center w-screen h-screen ">
          <div className=" p-12 flex justify-center items-center flex-col w-96 h-auto rounded-1xl bg-gradient-to-br from-greenR to-greenL shadow-2xl">
            <div className="flex justify-center items-center bg-background-union animate-pulse ease-out bg-no-repeat bg-center w-48 h-full">
              <h1 className="text-white font-extrabold text-9xl ">{level}</h1>
            </div>
